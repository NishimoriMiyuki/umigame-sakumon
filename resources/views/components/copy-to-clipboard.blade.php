...
<div x-data="{
        ...
        copyToClipboard(selector) {
            const copyText = document.querySelector(selector).value;
    ...
    <button type="button" 
        @click="copyToClipboard('{{ $selector }}');" 
        class="flex items-center justify-center w-auto h-8 px-3 py-1 text-xs bg-white dark:bg-gray-800 border border-transparent rounded-md cursor-pointer hover:bg-neutral-100 dark:hover:bg-gray-700 active:bg-white dark:active:bg-gray-800 focus:bg-white dark:focus:bg-gray-800 focus:outline-none text-neutral-500 hover:text-neutral-600 dark:text-white dark:hover:text-white group">
